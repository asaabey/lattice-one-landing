        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-gradient-to-br from-primary to-primary-dark rounded-lg flex items-center justify-center">
              <span className="text-primary-foreground font-bold">L1</span>
            </div>
            <span className="font-bold text-background font-serif">Lattice One</span>
          </div>
          ...
          <nav className="flex flex-wrap justify-center gap-6">
            {footerLinks.map((link) => (
              <a
                ...
                className="text-sm hover:text-background transition-colors flex items-center gap-1"
              >
